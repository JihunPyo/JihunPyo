![header](https://capsule-render.vercel.app/api?type=waving&color=0:1E3A8A,50:2563EB,100:14B8A6&height=200&section=header&text=Jihun%20Pyo&fontSize=50&fontColor=ffffff&animation=fadeIn&desc=Computer%20Vision%20%7C%20OCR%20%7C%20Machine%20Learning&descAlignY=70&descSize=18)

### Build, Test, and Learn Through Code

> 이미지와 데이터를 다루며 문제를 코드로 검증하는 개발자입니다.
...
|---|---|---|---|---|
| 2026 | Handwriting2Ink | OCR, Document Image Processing | 손글씨/손그림 문서 이미지에서 전경을 추출하고 skeleton 기반 stroke 좌표열로 변환하는 실험 프로젝트 | [GitHub](https://github.com/JihunPyo/Handwriting2Ink) |
| 2026 | KHUDA CV 8th DisabledParkingGuard | Computer Vision, Gait Analysis | CCTV 영상에서 하차 보행자의 보행 특성을 분석해 장애인 전용 주차구역 부정 이용 가능성을 추정하는 프로토타입 | [GitHub](https://github.com/JihunPyo/khuda-CV-8th) |
...
| ML Engineering | 실험 코드 구조화, 모델 추론 파이프라인 정리 |
...
> 컴퓨터 비전, OCR, 머신러닝 실험, 알고리즘 학습에 관심이 있습니다.
...
I am a developer interested in computer vision, OCR, machine learning experiments, and algorithmic problem solving.
...
- Machine learning inference pipelines and experiment records
- C++ algorithm practice through problem solving
